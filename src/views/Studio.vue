<template>
  <transition @leave="leave" :css="false">
    <div class="studio">
      ...
      <Img-view-title ref="imgViewTitle" :url="'https://res.cloudinary.com/micasastudios/image/upload/v1616974995/WEBPAGE/LOADINGS/LOADING_STUDIO_pkubum.jpg'" v-show="false"></Img-view-title>
